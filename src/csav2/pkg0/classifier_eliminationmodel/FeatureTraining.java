    ...
    public void trainFeatures() throws FileNotFoundException{
        ...
        while(scnr.hasNextLine()){
            ...
            if(line!=""){
                ...
                op1+=arr[8]+"\t"+arr[13]+"\t"+arr[14]+"\t"+arr[15]+"\t"+arr[16]+"\t"+arr[17]+"\t"+arr[18]+"\t"+arr[19]+"\t"+arr[20]+"\t"+arr[21]+"\t"+arr[22]+"\t"+arr[23]+"\t"+arr[24]+"\t"+arr[25]+"\n";
                op2+=arr[3]+"\t"+arr[14]+"\t"+arr[15]+"\t"+arr[16]+"\t"+arr[17]+"\t"+arr[18]+"\t"+arr[19]+"\t"+arr[20]+"\t"+arr[21]+"\t"+arr[22]+"\t"+arr[23]+"\t"+arr[24]+"\t"+arr[25]+"\n";
                op3+=arr[3]+"\t"+arr[8]+"\t"+arr[13]+"\t"+arr[18]+"\t"+arr[19]+"\t"+arr[20]+"\t"+arr[21]+"\t"+arr[22]+"\t"+arr[23]+"\t"+arr[24]+"\t"+arr[25]+"\n";
                op4+=arr[3]+"\t"+arr[8]+"\t"+arr[13]+"\t"+arr[14]+"\t"+arr[15]+"\t"+arr[16]+"\t"+arr[17]+"\t"+arr[21]+"\t"+arr[22]+"\t"+arr[23]+"\t"+arr[24]+"\t"+arr[25]+"\n";
                op5+=arr[3]+"\t"+arr[8]+"\t"+arr[13]+"\t"+arr[14]+"\t"+arr[15]+"\t"+arr[16]+"\t"+arr[17]+"\t"+arr[18]+"\t"+arr[19]+"\t"+arr[20]+"\t"+arr[23]+"\t"+arr[24]+"\t"+arr[25]+"\n";
                op6+=arr[3]+"\t"+arr[8]+"\t"+arr[13]+"\t"+arr[14]+"\t"+arr[15]+"\t"+arr[16]+"\t"+arr[17]+"\t"+arr[18]+"\t"+arr[19]+"\t"+arr[20]+"\t"+arr[21]+"\t"+arr[22]+"\t"+arr[25]+"\n";                                
            }
        }

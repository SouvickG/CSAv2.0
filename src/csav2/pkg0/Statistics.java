...
public class Statistics {
    ...
    */
    ...
    HashMap<String,Integer> fourgrams[] = new HashMap[MAX];
    ...
    int fourgmatchp[] = new int[MAX];
    
    int unimatchn[] = new int[MAX];
    int bimatchn[] = new int[MAX];
    int trimatchn[] = new int[MAX];
    int fourgmatchn[] = new int[MAX];
    
    int blpos[] = new int[MAX];
    int blneg[] = new int[MAX];
    int vspos[] = new int[MAX];
    int vsneg[] = new int[MAX];
    ...
    HashMap<String,Double> hmblpos = new HashMap();
    HashMap<String,Double> hmblneg = new HashMap();
    
    HashMap<String,Double> hmvspos = new HashMap();
    HashMap<String,Double> hmvsneg = new HashMap();
